...
public class Recipe
{
	...
	{	
		...
		{
			String path = "../src/Meal_Recipes/Corn_on_the_Cob.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Bucantini Alla Griccia With Gava Beans"))
		{
			String path = "../src/Meal_Recipes/Bucatini_Alla_Griccia_With_Fava_Beans.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Emergency Chicken"))
		{
			String path = "../CSC 131 Project/src/Meal_Recipes/Emergency_Chicken.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Instant Pot Collard Greens"))
		{
			String path = "../CSC 131 Project/src/Meal_Recipes/Instant_Pot_Collard_Greens.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Oven baked Parsley Red"))
		{
			String path = "../CSC 131 Project/src/Meal_Recipes/Oven_Baked_Parsley_Red_Potatoes.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Pressure Cooker Hard Boiled Eggs"))
		{
			String path = "../CSC 131 Project/src/Meal_Recipes/Pressure_Cooker_Hard_Boiled_Eggs.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Roasted Green Beans"))
		{
			String path ="../CSC 131 Project/src/Meal_Recipes/Roasted_Green_Beans.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Sauteed Radishes"))
		{
			String path ="../CSC 131 Project/src/Meal_Recipes/Sauteed_Radishes.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else if (Desired_Meal.equalsIgnoreCase("Spaghetti Carbonara"))
		{
			String path = "../CSC 131 Project/src/Meal_Recipes/Spaghetti_Carbonara.txt";
			File file = new File(path);
			Desktop.getDesktop().open(file);
		}
		else
